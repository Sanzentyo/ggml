...
void launch_fattn(
    ...
    if (stream_k) {
        if ((int)blocks_num.x % ntiles_dst == 0 && (int)blocks_num.x > ntiles_dst) {
            ...
            ggml_cuda_kernel_launch(flash_attn_stream_k_fixup_uniform<DV, ncols1, ncols2, DV_DST>, launch_params,
            ...
            const ggml_cuda_kernel_launch_params launch_params = ggml_cuda_kernel_launch_params(blocks_num_combine, block_dim_combine, 0, main_stream);
            ggml_cuda_kernel_launch(flash_attn_stream_k_fixup_general<DV, ncols1, ncols2, DV_DST>, launch_params,
                (float *) KQV->data, dst_tmp_meta.ptr,
        ...
        ggml_cuda_kernel_launch(flash_attn_combine_results<DV, DV_DST>, launch_params,
