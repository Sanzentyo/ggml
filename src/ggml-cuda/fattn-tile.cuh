...
static constexpr __host__ __device__ uint32_t ggml_cuda_fattn_tile_get_config_nvidia_fp16(const int DKQ, const int DV, const int ncols) {
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16,  2,  64, 2,  64,  16)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16,  4, 128, 2,  64,  16)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16,  8, 256, 2,  64,  16)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16, 16, 256, 2,  64,  16)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16, 32, 256, 2,  64,  16)
    ...
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56,  2,  64, 2,  64,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56,  4, 128, 2,  64,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56,  8, 256, 2,  64,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56, 16, 256, 2,  64,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56, 32, 256, 2,  64,  56)
...
static constexpr __host__ __device__ uint32_t ggml_cuda_fattn_tile_get_config_nvidia_fp32(const int DKQ, const int DV, const int ncols) {
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16,  2,  64, 2,  32,  16)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16,  4, 128, 2,  32,  16)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16,  8, 256, 2,  32,  16)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16, 16, 256, 2,  32,  16)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 16,  16, 32, 256, 2,  32,  16)
    ...
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56,  2,  64, 2,  32,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56,  4, 128, 2,  32,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56,  8, 256, 2,  32,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56, 16, 256, 2,  32,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56, 32, 256, 2,  32,  56)
...
static constexpr __host__ __device__ uint32_t ggml_cuda_fattn_tile_get_config_amd(const int DKQ, const int DV, const int ncols) {
    ...
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56, 16, 256, 2,  32,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56, 32, 256, 2,  32,  56)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 56,  56, 64, 256, 2,  32,  56)
...
template <int warp_size, int nwarps, int ncols1, int ncols2, int DKQ, int DV, int nbatch_fa, int nbatch_K,
    bool use_logit_softcap, bool has_mask, bool oob_check, typename T_vec_dot, typename T_KQ, typename T_acc>
...
template<int DKQ, int DV, int ncols1, int ncols2, bool use_logit_softcap, bool has_mask> // D == head size
...
#pragma unroll
    ...
    if (ncols2 == 1) {
        ...
        while (k_VKQ_0 < k_VKQ_max - nbatch_fa) {
            ...
            flash_attn_tile_iter<warp_size, nwarps, ncols1, ncols2, DKQ, DV, nbatch_fa, nbatch_K, use_logit_softcap, has_mask, oob_check>
...
template <int DKQ, int DV, int ncols2, bool use_logit_softcap, bool has_mask>
...
template <int DKQ, int DV, bool use_logit_softcap, bool has_mask>
static void launch_fattn_tile_switch_ncols2(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    ...
    if constexpr (DKQ == 320) {
        ...
        if (use_gqa_opt && gqa_ratio % 32 == 0) {
            launch_fattn_tile_switch_ncols1<DKQ, DV, 32, use_logit_softcap, has_mask>(ctx, dst);
            return;
        }
#else
        if (use_gqa_opt && gqa_ratio % 16 == 0) {
            launch_fattn_tile_switch_ncols1<DKQ, DV, 16, use_logit_softcap, has_mask>(ctx, dst);
            return;
        }
#endif // GGML_USE_HIP
    ...
    if constexpr (DKQ == 576) {
        ...
        if (use_gqa_opt && gqa_ratio % 4 == 0) {
            launch_fattn_tile_switch_ncols1<DKQ, DV, 4, use_logit_softcap, has_mask>(ctx, dst);
            return;
        }
    }
    ...
    if constexpr (DKQ <= 512 && DKQ != 320) {
        if (use_gqa_opt && gqa_ratio % 8 == 0) {
            launch_fattn_tile_switch_ncols1<DKQ, DV, 8, use_logit_softcap, has_mask>(ctx, dst);
            return;
        }
        ...
        if constexpr (DV <= 256) {
            if (use_gqa_opt && gqa_ratio % 2 == 0) {
                launch_fattn_tile_switch_ncols1<DKQ, DV, 2, use_logit_softcap, has_mask>(ctx, dst);
                return;
            }

            launch_fattn_tile_switch_ncols1<DKQ, DV, 1, use_logit_softcap, has_mask>(ctx, dst);
            return;
        }
    }
    GGML_ABORT("fatal error");
